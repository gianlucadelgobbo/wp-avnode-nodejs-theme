  ...
  helpers.setSessions(req, function() {
    helpers.getContainerPage(req, sez.post_type, function( posttype ) {
      ...
      helpers.getAll(req, sez, sez.limit, page, function( results ) {
        ...
        res.render(config.prefix+'/'+sez.puglist, {results: results, page_data:page_data, current_lang:req.current_lang, current_edition:req.current_edition, baseurl:sez.baseurl, posttype:posttype});
      });
    });
  });
};
