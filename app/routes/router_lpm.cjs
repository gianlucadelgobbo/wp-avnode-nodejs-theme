import indexRoutes from './index_lpm';
/* import timelinemapRoutes from './routes/lpm/timeline-map';
import usersRoutes from './routes/_common/users'; */

import sitemapRoutes from './_common/sitemap';
import signupRoutes from './_common/signup';
import editionsRoutes from './_common/editions';
/* import eventsRoutes from './_common/events';
import newsRoutes from './_common/news'; */
import pagesRoutes from './_common/pages';
import robotsRoutes from './_common/robots';
import metaRoutes from './_common/meta';
