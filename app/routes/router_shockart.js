...
module.exports = function(app) {
  ...
  app.get('/it/exhibitions/:edition/:subedition/:subsubedition/:image',  editionsRoutes.get);
  ...
  app.get('/exhibitions/:edition/:subedition/:subsubedition/:image',  editionsRoutes.get);
