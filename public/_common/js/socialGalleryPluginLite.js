...
function updateSideWrap(share){
	...
	*/
	...
	if(window.sgp_config.sgp_fb=="1"){
		j+='<div id="sgFB"><div class="fb-like" data-href="'+share+'"  data-layout="standard" data-action="like" data-size="small" data-share="true" data-show-faces="';
...
function loadItem(){
	...
	if(typeof a!="undefined"&&a!=""){
		...
		if(a!=""){
			...
			if (window.sgCurrind>=0 && window.glink && window.glink[window.sgCurrind] && window.glink[window.sgCurrind].media) {
				htmlstr = '<video class="embed-responsive-item video-js" id="my-video" controls="" autoplay="" preload="auto" width="640" height="264" poster="'+window.glink[window.sgCurrind].imageFormats.large+'" data-setup="{aspectRatio:&quot;16:9&quot;, fluid: true}"><source src="https://avnode.net'+window.glink[window.sgCurrind].media.file+'" type="video/mp4"><p class="vjs-no-js">To view this video please enable JavaScript, and consider upgrading to a web browser that<a href="http://videojs.com/html5-video-support/" target="_blank">false</a></p></video>';	
        ...
        sgShow();
		updateSideWrap(window.location.href);
...
function sgLeftAct(){
    ...
    if(typeof g!="undefined"&&g!=""){
      ...
      jQuery("#sgPluginLoader img").unbind("load")
      .load(function(){
        jQuery("#sgCont").html("");
        if(jQuery("#sgPluginLoader img").attr("title")=="undefined"){
          jQuery("#sgPluginLoader img").removeAttr("title")
	...
	*/
	...
	if(cnt_width>250||cnt_height>250){
		...
		*/
		...
		if (jQuery("#sgCont video").length) {
			jQuery("#sgCont video").css("margin-top",cntTopPos+"px");
			jQuery("#sgCont video").width(final_w_cnt);
			jQuery("#sgCont video").height(final_h_cnt);
		} else {
